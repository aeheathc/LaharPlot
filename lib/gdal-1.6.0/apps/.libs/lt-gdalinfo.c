...
/* ./.libs/lt-gdalinfo.c - temporary wrapper executable for .libs/gdalinfo.exe
   ...
   Currently, it simply execs the wrapper *script* "/bin/sh gdalinfo",
   but could eventually absorb all of the scripts functionality and
   exec .libs/gdalinfo.exe directly.
*/
#include <stdio.h>
#include <stdlib.h>
#include <unistd.h>

...
class OgrPINVOKE {
  ...
  public static extern void Feature_GetFieldAsIntegerList(HandleRef jarg1, int jarg2, out int jarg3, out int[] jarg4);

  [DllImport("ogr_wrap", EntryPoint="CSharp_Feature_GetFieldAsDoubleList")]
  public static extern void Feature_GetFieldAsDoubleList(HandleRef jarg1, int jarg2, out int jarg3, out double[] jarg4);

  [DllImport("ogr_wrap", EntryPoint="CSharp_Feature_GetFieldAsStringList")]
  public static extern void Feature_GetFieldAsStringList(HandleRef jarg1, int jarg2, HandleRef jarg3);
  ...
  public static extern void Feature_SetFieldStringList(HandleRef jarg1, int jarg2, HandleRef jarg3);

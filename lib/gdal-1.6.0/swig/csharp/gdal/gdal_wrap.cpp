...
SWIGEXPORT GDALMajorObjectShadow * SWIGSTDCALL CSharp_ColorTableUpcast(GDALColorTableShadow *objectRef) {
    return (GDALMajorObjectShadow *)objectRef;
}

SWIGEXPORT GDALMajorObjectShadow * SWIGSTDCALL CSharp_RasterAttributeTableUpcast(GDALRasterAttributeTableShadow *objectRef) {
    return (GDALMajorObjectShadow *)objectRef;
}
